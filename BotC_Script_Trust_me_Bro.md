...
möglichst viele Siegmodifikationen. Viel Blöffen und Raten. Wenig und möglicherweise defekte Inforollen.
- Rationalist (Atheist) (interessant mit Politician, Bounty Hunter, Puzzledrunk oder mit einem Philsopher)
- (Cult Leader)
- Adulterator (Innkeeper*)
- Blabber (Gossip)
- (Dreamer*)
- (Savant)
- (Alsaahir)
- [(Grandmother)] (interesting with Leviathan)
- Faustian* (Gambler+Lycanthrope)
- Poppy Snitch (Poppy Grower + Snitch combined)
- (Chambermaid*) (few good people wake at night, each night = `*`, one night only = `(*)`, this makes this role valuable)
- (Bounty Hunter*) (do not make the bounty hunter the evil townsfolk, trust will become difficult in case of Legion)
- (Knight(*)) (Knight + Legion would be quite funny, the knight may get itself as info)
- (Sage) (usually, the evil team might win quickly. This allows the good team to win quickly and make the demon afraid of killing bully-outed people.)
- Seelenverwandte(*) (Storm-catched)
- Puzzledrunk (false Wizard claims would help to obscure insights of strong players)
- Muezzin (Adulterator, Puzzlemaster and Prosecutor can make players drunk. With Muezzin, only one of your team can be. If the Muezzin is evil, Pandemon poisons ≤1 Minion and the Legionatic is like an enhanced Legion.)
- [(Farmer)] (meta reasoning)
- [(Mayor)] (good wins when no execution happens when 3 people are left)

Outsider:
- (Lunatic*) [fits to Atheist, Pandemon, Polymath]
- Master Hora (multiple executions consecutively, fits to Trustmaker, Butcher, Leviathan/Diabolus)
- [Anarchist]
- (Politician) (fits to Heretic, Atheist and may (double) claim the Saint, the Good Twin, the Goblin or the Puzzledrunk)
- Wicked (Heretic)
- Victim  (originally Damsel)
...
- [(Plague Doctor)] (turning the story teller into an evil twin is almost funny, turning into Xaan changes the outsiders)
- [(Barber)] (evil switches two characters when this dies)
- [(Recluse)]
- [(Ogre*)]
- [(Goon)]
...
- Scaremonger* (alternative to Fearmonger) (with Wicked this can be brutal)
- (Spy*) (added because they can appear and play like a good Townsfolk character, interesting for Cult Leader or various info characters)
- [(Pit-Hag*)] (a pit-hag making a demon can seem like an atheist is in play, causes havoc when heretic is in play)
- [(Marionette)]
- [(Boffin)]
- [(Wizard(*))]
- [(Mastermind)] (in combination with Mayer)
- [(Mezepheles)] (use with Yaggababble, kind of cheap with Spirit of Ivory)

Demons:
- (Vortox*) (upside down info)
- (Leviathan) (no demon kills but any executions)
- Diabolus (only together with Leviathan)
- Legionatic (alternative to Legion) (no minions, 2/3 players are demon)
- (Fang Gu*) (killed outsider gets demon instead, good with knight, +1 outsider)
- Pandemon (has all minions abilities, all minions are defect, demon detection is defect)
- [(Yaggababble)] (saying a phrase kills a person each time)
- [(Kazali*)] (choose your minions at setup time, any outsiders)
- [(Lord of Typhon)] (additional minions but all in one row)
...
Fableds:
- [Revolutionary] (two people of equal alignment set next to each other, one time misregistered)
- (Doomsayer) (everyone may wish to have one person of their alignment killed)
- (Sentinel) (-1 to +1 outsider)
- [Hell's Librarian] (do nasty stuff with players who won't be quiet)
- Probationer, Spirit of Irony (extension of Spirit of Ivory) (at most one player gets evil additionally)
- (Ferryman) (all dead have one vote token on the final day)
...
- (Stormcatcher)
  - Soulmate
  - Cult Leader
  - an info character if it is the only good info character
  - NOT bounty hunter!c
- [Zenomancer]
  - Zenomancer (Politician): When the politician is mad about ending the game upon their execution (or a character that would), after execution they learn one not-in-play strong good character that is not an evil bluff.
