...
- Atheist (soll defekt sein können)
- Cult Leader
- Innkeeper*
- Gossip
- Dreamer*
- Savant
- Alsaahir
- Grandmother (interesting with Leviathan and Politician)
- Gambler*
- Poppy Grower + Snitch combined
...
- Heretic
- Damsel
- Klutz (interesting with Legion)
- Puzzlemaster (allowing for Drunk Atheist, useful for Pandemon)
...
- Fearmonger* (with Heretic this can be brutal)
- Spy*
...
- Legion (no minions, 2/3 players are demon)
